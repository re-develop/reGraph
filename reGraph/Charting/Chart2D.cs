...
{
  public abstract class Chart2D : ISizeable
  {
    private Chart2DStyle style { get; set; }
    protected DataCollection DataSource { get; private set; }
    ...
    protected virtual void drawBaseLabel(Graphics ctx, float x, string content)
    {
      ...
      if (style.DrawAxisHelpLine.HasFlag(Axis2D.AxisY) && x > paddedWidth)
      {

...
namespace AeoGraphing.Charting.LineChart
{
  public class LineChart : ISizeable
  {
    ...
    private void drawDataGroups(Graphics ctx)
    {
      ...
      var dwidth = pWidth - lastX;
      var requiredWidth = graphics.MeasureString(DataSource.DataGroupNames[i - 1], _style.DataCaptionFont).Width;
